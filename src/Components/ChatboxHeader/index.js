    ...
    return (
        <div className="chatbox__person">
            <span className="chatbox__avatar">
                <img src={details.imgSrc} alt="Debby Jones" />
            </span>
